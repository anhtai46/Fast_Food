    ...
    <body>
        ...
        <%
            ...
            if (request.getAttribute("payment") != null) {
                boolean success = (boolean) request.getAttribute("payment");
                if (success) {
                    out.print("<script>alert('Mua thành công')</script>");
                } else {
                    out.print("<script>alert('Mua thất bại')</script>");
                }
            }
        %>
        ...
        <div class="container">
            <div class="container list-order ">
                ...
                <!-- Paging -->
                <div class="row">
                    <div class="col-md-12 paging-navigation">
                        <ul class="list-page">
                            <li class="page-icon">
